...
<section class="pageheader-default" style="background:url(../../public/img/7.jpg);">
	<div class="bgarea-semitransparent">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1 class="landingpage animated fadeInLeftBig notransition">Great Theme you will love</h1>
					...
					<div class="btn-wrap animated fadeInUpBig notransition">
						<a class="btn btn-minimal" href="#">Download NOW</a><span>or</span><a class="btn btn-minimal" href="elements.html">Learn more</a>
					</div>
				</div>
				<div class="col-md-6">
				...
				<ul class="ca-menu">
					...
					<div class="grey-box-icon">
						...
						<div class="ca-content">
							...
							<h3 class="ca-sub">Across all major devices created for you and your business prosperity and your clients' projects.</h3>
						</div>
					</div>
					</a>
					</li>
					...
					<div class="grey-box-icon">
						...
						<div class="ca-content">
							...
							<h3 class="ca-sub">Straight to the point highly-professional &amp; modern website template</h3>
						</div>
					</div>
					</a>
					</li>
					...
					<div class="grey-box-icon active">
						...
						<div class="ca-content">
							...
							<h3 class="ca-sub">Wide layout, boxed layout, semiboxed layout, unlimited color skins, check out the demo panel</h3>
						</div>
					</div>
					</a>
					</li>
					...
					<div class="grey-box-icon">
						...
						<div class="ca-content">
							...
							<h3 class="ca-sub">Highly-professional &amp; modern website template created for your business</h3>
						</div>
					</div>
					</a>
					</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 animated fadeInLeftNow notransition">
					<div class="tabs">
						<ul class="nav nav-tabs">
							...
							<li><a href="#special" data-toggle="tab">Special Features</a></li>
						</ul>
				...
				<div class="col-md-8 home-features animated fadeInRightNow notransition">
					<div class="row">
						<div class="col-md-6">
							<h4><i class="icon icon-magic"></i>Winning Template</h4>
